    ...
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center ">
          <div className="w-[35%] max-md:w-[50%] max-sm:w-[90%] h-[80vh] bg-white rounded shadow relative overflow-y-scroll">
      ...
      {user &&
        user.addresses.map((item, index) => (
          <div
            className="w-full bg-white max-md:h-min h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10 mb-5"
            key={index}
          >
            <div className="flex items-center">
